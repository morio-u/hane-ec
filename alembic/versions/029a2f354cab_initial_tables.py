...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('man', 'woman', 'other', 'na', name='genderenum'), nullable=False),
    ...
    sa.Column('purchase_type', sa.Enum('consignment', 'purchase', 'in_house', 'other', name='purchasetypeenum'), nullable=False),
    sa.Column('price_excluding_tax', sa.DECIMAL(precision=12, scale=2), nullable=True),
    sa.Column('cost_price', sa.DECIMAL(precision=12, scale=2), nullable=True),
    sa.Column('status', sa.Enum('draft', 'active', 'inactive', 'discontinued', name='productstatusenum'), nullable=False),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['brand_id'], ['brands.id'], ),
    sa.ForeignKeyConstraint(['shipping_rule_id'], ['shipping_rules.id'], ),
    ...
    op.create_index(op.f('ix_products_internal_part_number'), 'products', ['internal_part_number'], unique=True)
    ...
    sa.Column('status', sa.Enum('active', 'out_of_stock', 'inactive', 'discontinued', name='skustatusenum'), nullable=False),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
